/*
	This sketch was for Tyrel to use when configuring the Dragino
	It just sends a message formatted for the MQTT server.
...
//  }
  ...
  // Changed from 5 for Tyrel to use it
  else if (first == 0x54){
    ID = 1;
  }
  else if (first == 0x5F){
...
void loop()
{
  ...
  if (ID == 1){
    ...
    // Something arrived, forward it onto the GSG
    if (rf95.available())
    {
